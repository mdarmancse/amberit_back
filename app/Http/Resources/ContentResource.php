...
class ContentResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $gmcConfig=$this->cdn_gmc_conf?json_decode($this->cdn_gmc_conf):null;
        return [
            'id' => $this->id,
            ...
            'mediaUrl' =>$gmcConfig?$gmcConfig->mediaUrl:null,
            'is_cdn_active' =>$gmcConfig?$gmcConfig->isActive:null,
            'cdnName' =>$gmcConfig?$gmcConfig->cdnName:null,
            'keyName' =>$gmcConfig?$gmcConfig->keyName:null,
            'privateKey' =>$gmcConfig?$gmcConfig->privateKey:null,
            'expireTimeInHours' =>$gmcConfig?$gmcConfig->expireTimeInHours:null,
