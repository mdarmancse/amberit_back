...
//            });
            ...
            return ApiResponse::success(['value' => 0, 'cached' => $isCached], null, $isCached ? 'Total VOD views fetched from cache.' : 'Total VOD views fetched successfully.');
        } catch (\Throwable $e) {
            return ApiResponse::error(500, $e->getMessage(), 'Something went wrong!');
        }
    }
...
//            $totalAudience = $totalAudienceQuery->info()['rows'][0]['f'][0]['v'];
            ...
            return ApiResponse::success(['value' => 0], null, 'Total Live Audience fetched successfully.');
        } catch (\Throwable $e) {
            return ApiResponse::error(500,  $e->getMessage(),'Something went wrong!');
        }
    }
...
//            });
            ...
            return ApiResponse::success(['value' => 0, 'cached' => $isCached], null, $isCached ? 'Total Live views fetched from cache.' : 'Total Live views fetched successfully.');
        } catch (\Throwable $e) {
...
//        });
        ...
        return ApiResponse::success(['value' => 0, 'cached' => $isCached], null, $isCached ? 'Login users fetched from cache.' : 'Login users fetched successfully for the specified date.');
    }
...
//            }
     ...
     //   }
        $toptendata=[];
        return ApiResponse::success(['value' => $toptendata,'cached' => false], null, 'Top ten live content fetched successfully.');
    }
